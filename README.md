...
**Open Agent Project**, and select `apps/example-agent`. The example includes a
deterministic tool and skill, so its source contract can also be checked without
a configured model:
