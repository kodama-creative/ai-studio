...
| Run real Docker Sandbox acceptance     | `bun run test:docker`                                                        | requires a running Docker-compatible Engine; exercises isolation, workspace, attachments, canonical tools, and cleanup |
