...
export const PROMPT_DATE_FORMATS: ReadonlyArray<PromptVariableFormatOption<PromptDateVariableFormat>> =
  [
...
export const PROMPT_SKILLS_FORMATS: ReadonlyArray<PromptVariableFormatOption<PromptSkillsVariableFormat>> =
  [
    { value: "xml", label: "XML" },
