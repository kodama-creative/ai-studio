...
const MENU_ACTION_COMMANDS: Record<string, Command> = {
  ...
  newPlayground: { type: "playground.create", args: {} },
  newFromExamples: { type: "playground.openExamples", args: {} },
  importFiles: { type: "playground.importFiles", args: {} },
  importFromClipboard: { type: "playground.importFromClipboard", args: {} },
