...
import { openPath, revealInFileManager } from "./reveal";

interface RevealResourceDependencies {
 ...
 * Internal skill locators resolve through the registry before touching the OS.
 */
