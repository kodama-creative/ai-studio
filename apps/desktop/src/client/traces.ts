...
export const traceClient = {
  ...
  async createConnectedProject(input: TraceConnectedProjectInput) {
  ...
  async importLangfuseJson(projectId: string, files: TraceImportFile[]) {
  ...
  async syncLangfuseTraces(projectId: string, traceIds: string[]) {
  ...
  async updateTraceTitle(projectId: string, traceKey: string, title: string) {
